...
from util_p import shape_list
from layers import (entity_avg_pooling_masked, entity_max_pooling_masked,
...
def construct_tf_graph(all_inputs, spec, scope='', reuse=False,):
    '''
