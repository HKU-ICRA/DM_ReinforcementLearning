...
def train():
    ...
    learn(env=env, eval_env=None, total_timesteps=2e6, nsteps=20, nminibatches=1,
          cliprange=0.2, ent_coef=0.01, vf_coef=0.5, lam=0.95, gamma=0.99, noptepochs=5, lr=3e-4,
          save_interval=100, save_dir=".", load_path="./checkpoints/05000")
