...
class Model(object):
    ...
    def __init__(self, ob_space, ac_space, nbatch_act, nbatch_train,
        ...
        act_model = MAPolicy(scope="ppo2_model", ob_space=ob_space, ac_space=ac_space, network_spec=network_spec, v_network_spec=None,
        ...
        train_model = MAPolicy(scope="ppo2_model", ob_space=ob_space, ac_space=ac_space, network_spec=network_spec, v_network_spec=None,
        ...
        params = tf.trainable_variables(scope="ppo2_model") #act_model.get_trainable_variables() + train_model.get_trainable_variables()
        # 2. Build our trainer
    ...
    def train(self, lr, cliprange, obs, returns, actions, dones, values, neglogpacs, states=None):
        ...
        #var_check = self.sess.run(self.train_model.scaled_value_tensor, td_map)
        #print(var_check)
